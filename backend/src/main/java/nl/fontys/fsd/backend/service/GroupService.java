...
public class GroupService {
    ...
    public List<GroupCardDTO> getGroupCardsForUser(Long userId) {
        List<GroupCardDTO> groups = groupRepository.findGroupsForUser(userId);
    ...
    public void updateGroup(Long groupId, Long requestingUserId, GroupUpdateDTO dto) {
        ...
        if (!userRole.equals("TEAMLEIDER")) {
            throw new RuntimeException("Geen toegang, alleen teamleiders mogen groepsgegevens bewerken");
        }
